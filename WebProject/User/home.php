...
<body class="bg-slate-100" >
    ...
    <!-- Tab start-->
    <div class="text-center bg-slate-100 border-gray-200 px-2 md:px-4 py-2.5 dark:bg-gray-900 items-center mx-auto max-w-screen-xl" style="text-align: center;">
    ...
    <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900 mt-[50px]">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="#" class="flex items-center">
                    <img src="https://images-platform.99static.com//Rbp6UTD5R54GLM04Xnw1qI-BKC4=/708x713:1297x1301/fit-in/590x590/99designs-contests-attachments/126/126734/attachment_126734144" class="mr-3 h-8" alt="FlowBite Logo">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Techmall</span>
                </a>
            </div>
