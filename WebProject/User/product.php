...
<body class="bg-slate-100" >
                ...
                <div class="ml-[10px] mt-[10px] py-[10px]">
                    ...
                    <form id="amount" action="../User/CardAndBuy/addToCartProcess.php" method="get">
                        ...
                        <div class="flex items-center md:order-2 mt-[50px]">
                            <!-- Add to cart -->
                            <button id="submit" onclick="btnSearchClick()" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    <!-- Modal toggle -->
                    <button id='5' class="hidden block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="popup-modal">
                        Toggle modal
                    </button>
    ...
    <script>
        setTimeout(function () {document.getElementById('5').click();}, 500);
    </script>
</body>
</html>