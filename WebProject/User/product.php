        ...
        <div class="bg-white py-[10]" >
            <div class="m-[10px] grid grid-cols-3 gap-5" >
                ...
                <div class="ml-[10px] mt-[10px] py-[10px]">
                    ...
                    <form id="amount" action=<?=$domain."User/CardAndBuy/addToCartProcess.php"?> method="get">
                        <div class="grid grid-cols-2 justify-between items-center mt-[50px]">
                            ...
                            <div class="flex">
                                ...
                                <input class=" w-[30px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="amount" id="number" value="1" />
                        ...
                        <div class="flex items-center md:order-2 mt-[50px]">
                            ...
                            <!-- Check purchase of this product to redirect -->
                            
                            <a href=<?=$domain."User/CardAndBuy/addToCartProcess.php?check=1&product_id=".$ID?> >
                            ...
                            <div id="popup-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full">
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Warning: Sign in to continue!!!</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
